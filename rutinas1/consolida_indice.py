...
files = os.listdir("C:\\SUDCRApy2\\datosSAP\\indice")
df2 = pd.DataFrame()
...
for file in excel_files:
    pathfile= "C:\\SUDCRApy2\\datosSAP\\indice\\" + file
    print(pathfile)
...
df2.to_csv('C:\\SUDCRApy2\\datosSAP\\INDICE.csv', index=False, sep=";", encoding='utf-8-sig')
